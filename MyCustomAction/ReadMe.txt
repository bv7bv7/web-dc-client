...
Эта библиотека DLL MyCustomAction создана автоматически с помощью 
мастера приложений.

Здесь приведены краткие сведения о содержимом каждого из файлов, использованных 
при создании приложения MyCustomAction.


MyCustomAction.vcxproj
...
MyCustomAction.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) с именем MyCustomAction.pch и файла предкомпилированных типов 
    с именем StdAfx.obj.
